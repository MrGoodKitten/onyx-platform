...
class Corona(GenericRenderer):
    ...
    def multi_material_script(self, node_name, mat_name, is_glass):
        if is_glass:
            ...
            return self.GetOpaqueMaterial(node_name, mat_name)
    ...
    def post_material_script(self):
        return super().post_material_script(show = (self.coronaVersion < 7), deselect=False, rearrange=False)
    ...
    def GetOpaqueMaterial(self, nodeName, matName):
        if self.coronaVersion > 6:
            ...
            lutPath = os.path.join(dirPath, "_SpecularToIOR.CUBE").replace("\\", "/")
            ...
            (
                ...
                (
                    ...
                    MAT_NODE_NAME.texmapFresnelIor.map.lutFile = "{lutPath}"
